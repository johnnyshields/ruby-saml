...
Until RubySaml 3.0.0, using the old name will raise a deprecation warning but otherwise function as an alias
to the newly-named parameters. Beginning in **RubySaml 3.0.0**, using the old name will raise a `NotImplemented` error.
Aside from the name, there are no changes to the usage or functionality of these parameters.

| Old Parameter                               | New Parameter                           |
|---------------------------------------------|-----------------------------------------|
| `issuer`                                    | `sp_entity_id`                          |
| `certificate`                               | `sp_cert` (alias `sp_certificate`)      |
