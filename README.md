...
When requiring the gem, you can add the whole Ruby SAML:
...
And on 'signing' and 'encryption' arrays, add the different IdP X.509 public certificates published on the IdP metadata.
...
#### Certifcate and Signature Validation
